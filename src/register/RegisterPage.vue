    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <input type="password" v-model="user.password_confirmation" v-validate="{ required: true, min: 6 }" name="password_confirmation" class="form-control" :class="{ 'is-invalid': submitted && errors.has('password_confirmation') }" />
